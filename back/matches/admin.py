...
class MatchAdmin(admin.ModelAdmin):
    ...
    list_display = ['home_team', 'away_team', 'date', 'time', 'status', 'score_display', 'stadium']
    list_filter = ['status', 'date', 'season', 'home_team', 'away_team']
    ...
    fieldsets = (
        ...
        ('Время и место', {
            'fields': ('date', 'time', 'stadium', 'round')
        }),
        ('Результат', {
